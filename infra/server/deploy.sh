...
required_variables=(
  ...
  LOCKER_BASE_URL LOCKER_INTEGRATION_TOKEN CAMPAIGN_LINK_SECRET
...
for variable_name in POSTGRES_PASSWORD APP_DB_PASSWORD OIDC_CLIENT_SECRET LOCKER_INTEGRATION_TOKEN CAMPAIGN_LINK_SECRET; do
