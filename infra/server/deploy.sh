...
set +a
required_variables=(
  CRM_DOMAIN ID_DOMAIN ACME_EMAIL
  ...
  LOCKER_BASE_URL LOCKER_INTEGRATION_TOKEN CAMPAIGN_WEBHOOK_SECRET
  S3_ENDPOINT S3_UPSTREAM S3_BUCKET S3_ACCESS_KEY S3_SECRET_KEY
)
...
for variable_name in POSTGRES_PASSWORD APP_DB_PASSWORD OIDC_CLIENT_SECRET LOCKER_INTEGRATION_TOKEN CAMPAIGN_WEBHOOK_SECRET; do
